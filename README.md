...
uses the compiler's internals to generate the docs and this inturn makes it
...
recognize that there are lots of improvements we can do to the rust-doc tool, we
first need to make move it to a separate repository and have it achieve feature
parity with the current docs. Having said that this is not the only purpose of
this project and we plan to add more features once the feature parity is
achieved. Take a look at [The Rustdoc
Redux](https://internals.rust-lang.org/t/the-rustdoc-redux/5542) for more about
